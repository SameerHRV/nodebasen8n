  ...
  return (
    <div className="relative">
      ...
      <Input
        ...
        className="pl-10 max-w-[200px] bg-background shadow-none border-border"
      />
    </div>
  );
};

interface EntityPaginatinProps {
  page: number;
  totalPages: number;
...
export const LodingView = ({ message }: StateViewProps) => {
  return (
...
export const EmptyView = ({ noNew, message }: EmptyViewProps) => {
  return (
    <Empty className="border border-dashed bg-white">
      ...
      {!!noNew && (
        <EmptyContent>
          <Button onClick={noNew}>Create new</Button>
        </EmptyContent>
      )}
    </Empty>
  );
